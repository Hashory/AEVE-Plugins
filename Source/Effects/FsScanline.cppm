...
inline PF_Pixel PX8(PF_Pixel c, double lv, double opa) {
  ...
  if (lv == 0) {
    ...
    ret.red = RoundByteLong(
        (A_long)((double)c.red + (PF_MAX_CHAN8 - (double)c.red) * lv + 0.5));
    ret.green = RoundByteLong((
        A_long)((double)c.green + (PF_MAX_CHAN8 - (double)c.green) * lv + 0.5));
    ret.blue = RoundByteLong(
        (A_long)((double)c.blue + (PF_MAX_CHAN8 - (double)c.blue) * lv + 0.5));
  } else {
    ret.red =
        RoundByteLong((A_long)((double)c.red + ((double)c.red) * lv + 0.5));
    ret.green =
        RoundByteLong((A_long)((double)c.green + ((double)c.green) * lv + 0.5));
    ret.blue =
        RoundByteLong((A_long)((double)c.blue + ((double)c.blue) * lv + 0.5));
  }
...
inline PF_Pixel16 PX16(PF_Pixel16 c, double lv, double opa) {
  ...
  if (lv == 0) {
    ...
    ret.red = RoundShort(
        (A_long)((double)c.red + (PF_MAX_CHAN16 - (double)c.red) * lv + 0.5));
    ret.green =
        RoundShort((A_long)((double)c.green +
                            (PF_MAX_CHAN16 - (double)c.green) * lv + 0.5));
    ret.blue = RoundShort(
        (A_long)((double)c.blue + (PF_MAX_CHAN16 - (double)c.blue) * lv + 0.5));
  } else {
    ret.red = RoundShort((A_long)((double)c.red + ((double)c.red) * lv + 0.5));
    ret.green =
        RoundShort((A_long)((double)c.green + ((double)c.green) * lv + 0.5));
    ret.blue =
        RoundShort((A_long)((double)c.blue + ((double)c.blue) * lv + 0.5));
  }
...
inline PF_PixelFloat PX32(PF_PixelFloat c, double lv, double opa) {
  ...
  if (lv == 0) {
    ...
    ret.green =
        RoundFpShortDouble(((double)c.green + (1 - (double)c.green) * lv));

...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color0", 0xFF, 0xFF, 0xFF, ID_COLOR0);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color1", 0xFF, 0x00, 0x00, ID_COLOR1);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color2", 0x00, 0xFF, 0x00, ID_COLOR2);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color3", 0x00, 0x00, 0xFF, ID_COLOR3);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color4", 0xFF, 0xFF, 0x00, ID_COLOR4);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color5", 0xFF, 0x00, 0xFF, ID_COLOR5);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color6", 0x00, 0xFF, 0xFF, ID_COLOR6);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color7", 0x00, 0x00, 0x00, ID_COLOR7);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color8", 0x80, 0x80, 0x80, ID_COLOR8);
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR("color9", 0xFF, 0x80, 0xFF, ID_COLOR9);

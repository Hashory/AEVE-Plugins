...
static PF_Err BlurRedHor(CFsGraph* g, A_long blue, A_u_short* scanline,
                         A_long* tbl) {
...
static PF_Err BlurRedVur(CFsGraph* g, A_long blue, A_u_short* scanline,
                         A_long* tbl) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err BlurAllHor(CFsGraph* g, A_long blue, PF_Pixel16* scanline,
                         A_long* tbl) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err BlurAllVur(CFsGraph* g, A_long blue, PF_Pixel16* scanline,
                         A_long* tbl) {
  PF_Err err = PF_Err_NONE;

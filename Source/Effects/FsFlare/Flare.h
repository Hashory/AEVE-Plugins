...
enum {
  ...
  ID_MODE,       // Mode  WhiteBaseMask or BlackBaseMask or Image(lumnan)
  ID_BASE_ON,
  ID_BASE_COLOR,
  ID_BASE_OPACITY,
  ID_OFFSET
...
enum {
  ...
  ID_BORDER_TOPIC,
  ID_BORDER,   // Border Image
  ID_INSIDE,   // inside border
  ID_OUTSIDE,  // outside border
  ID_BORDER_TOPIC_END,
  ID_MAX,    // Expansion size
  ID_BLUR,   // Blur size
  ID_COLOR,  // Used for color and border
...
enum MODE { WhitebasedMask = 1, BlackbasedMask, Alpha, Image };

enum REVMODE { None = 1, Reverse, ReverseAndOriginalAlpha };
enum BLEND {
  Screen = 1,
  Add,
  Normal,

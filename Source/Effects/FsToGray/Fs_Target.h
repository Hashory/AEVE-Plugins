...
#define FS_DESCRIPTION "Grayscales in various ways"

// Menu name where the plugin is displayed
#define FS_CATEGORY "NF's Plugins-Colorize"

// Enable this for SmartFX + Float_Color support
#define SUPPORT_SMARTFX
// #define NO_USE_FSGRAPHICS	// Enable this to prevent including FsGraphics
// related files
...
// #define FS_OUT_FLAGS	33556036	// Enable this to draw every frame. Also
// use this when switching NON_PARAM_VARY during operation. #define FS_OUT_FLAGS
// 1600		// 8bit only

...
// Characters used for the plugin description
#define FS_DESCRIPTION "Draw touch lines"
...
// If this is enabled, it will be drawn every frame. Also use this when
// switching NON_PARAM_VARY during operation.

...
static PF_Err FindTargetColorSub8(refconType refcon, A_long xL, A_long yL,
  ...
  FindTargetColorParam8 *infoP =
      reinterpret_cast<FindTargetColorParam8 *>(refcon);
...
static PF_Err FindTargetColorSub16(refconType refcon, A_long xL, A_long yL,
...
static PF_Err FindTargetColorSub32(refconType refcon, A_long xL, A_long yL,
...
PF_Err FindTargetColor8(CFsAE *ae, PF_Pixel target_color, A_long color_range,
                        A_long *count) {
  PF_Err err = PF_Err_NONE;
...
PF_Err FindTargetColor16(CFsAE *ae, PF_Pixel target_color, A_long color_range,
                         A_long *count) {
  PF_Err err = PF_Err_NONE;
  FindTargetColorParam8 info;
  info.count = 0;
...
PF_Err FindTargetColor32(CFsAE *ae, PF_Pixel target_color, A_long color_range,
                         A_long *count) {
  PF_Err err = PF_Err_NONE;
  FindTargetColorParam8 info;
  info.count = 0;
...
//*************************************************************************************************
// Look at red to extract edges and flag blue
//*************************************************************************************************
static PF_Err FindEdgeSub8(refconType refcon, A_long xL, A_long yL,
                           PF_Pixel8 *inP, PF_Pixel8 *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err FindEdgeSub16(refconType refcon, A_long xL, A_long yL,
                            PF_Pixel16 *inP, PF_Pixel16 *outP) {
  PF_Err err = PF_Err_NONE;
  FindEdgeParam *infoP = reinterpret_cast<FindEdgeParam *>(refcon);
...
static PF_Err FindEdgeSub32(refconType refcon, A_long xL, A_long yL,
                            PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  FindEdgeParam *infoP = reinterpret_cast<FindEdgeParam *>(refcon);

...
static PF_Err Iterate32(CFsAE *ae, ParamInfo32 *niP,
                        PF_Err (*pix_fn)(refconType refcon, A_long x, A_long y,
                                         PF_Pixel32 *in, PF_Pixel32 *out)) {
...
static PF_Err GetTargetPixels32(refconType refcon, A_long xL, A_long yL,
                                PF_Pixel32 *inP, PF_Pixel32 *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err AlphaTargetToGreen32(refconType refcon, A_long xL, A_long yL,
...
static PF_Err SwapGB32(refconType refcon, A_long xL, A_long yL,
                       PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err RedToGreen32(refconType refcon, A_long xL, A_long yL,
                           PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err AlphaON32(refconType refcon, A_long xL, A_long yL,
                        PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err MaskedGBFromA32(refconType refcon, A_long xL, A_long yL,
                              PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err MaxHorG2R32(refconType refcon, A_long xL, A_long yL,
                          PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err MaxVurG2R32(refconType refcon, A_long xL, A_long yL,
                          PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err MoveG2R32(refconType refcon, A_long xL, A_long yL,
                        PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err SplitG2RGB32(refconType refcon, A_long xL, A_long yL,
                           PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err Noise32(refconType refcon, A_long xL, A_long yL,
                      PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err CopyTagetEX32(refconType refcon, A_long xL, A_long yL,
                            PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err GreenToAlpha32(refconType refcon, A_long xL, A_long yL,
                             PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err BlueToAlpha32(refconType refcon, A_long xL, A_long yL,
                            PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_FpLong LvSet32(PF_FpLong src, PF_FpLong lv, PF_FpLong alpha) {
  PF_FpLong ret = 0;
...
static PF_Err ColorSet32(refconType refcon, A_long xL, A_long yL,
                         PF_PixelFloat *inP, PF_PixelFloat *outP) {
  PF_Err err = PF_Err_NONE;
  ParamInfo32 *niP = reinterpret_cast<ParamInfo32 *>(refcon);
...
static PF_Err debug32(CFsAE *ae, ParamInfo32 *pi) {
  PF_Err err = PF_Err_NONE;
  ...
  if (pi.TargetCount > 0) {
    ...
    if ((pi.info.hi_length > 0) || (pi.info.sw_length > 0)) {
      ...
      if ((pi.info.hi_blur > 0) || (pi.info.sw_blur > 0)) {
        pi.scanlineH = ae->NewHandle(pi.scanlineSize * sizeof(PF_FpShort) * 4 +

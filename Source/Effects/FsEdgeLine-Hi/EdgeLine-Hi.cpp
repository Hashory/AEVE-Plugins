...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  // Specify color
  AEFX_CLR_STRUCT(def);
  // If this is enabled, keyframes cannot be set
  // def.flags = PF_ParamFlag_CANNOT_TIME_VARY;
  PF_ADD_COLOR(STR_TARGET_COLOR, 0xFF, 0xFF, 0x00, ID_TARGET_COLOR);

  AEFX_CLR_STRUCT(def);
  // def.flags = PF_ParamFlag_CANNOT_TIME_VARY;
  PF_ADD_COLOR(STR_SAMPLE_COLOR, 0xFF, 0x00, 0x00, ID_SAMPLE_COLOR);
  AEFX_CLR_STRUCT(def);
  ...
  PF_ADD_SLIDER(STR_LENGTH,  // Parameter name
                ...
                20,          // Maximum value of the slider
                0,           // Default value
                ID_LENGTH);
  // Angle
  AEFX_CLR_STRUCT(def);
  ...
  AEFX_CLR_STRUCT(def);
  // def.flags = PF_ParamFlag_CANNOT_TIME_VARY;
  PF_ADD_COLOR(STR_DRAW_COLOR, 0xFF, 0x00, 0xFF, ID_DRAW_COLOR);
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_SCANFLAG, STR_SCANFLAG2, FALSE, 0, ID_SCANFLAG);
...
/*
 ...
 (After Effects 7 or earlier). Writing this function ensures compatibility with
 v6.5.
*/

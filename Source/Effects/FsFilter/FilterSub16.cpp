...
PF_Err ExtractHiSub(refconType refcon, A_long xL, A_long yL, PF_Pixel16 *px) {
  PF_Err err = PF_Err_NONE;
...
PF_Err ExtractLoSub(refconType refcon, A_long xL, A_long yL, PF_Pixel16 *px) {
  PF_Err err = PF_Err_NONE;
  ExtractInfo *infoP = reinterpret_cast<ExtractInfo *>(refcon);
  PF_Pixel16 bl = {0, 0, 0, 0};
...
PF_Err RevSub(refconType refcon, A_long xL, A_long yL, PF_Pixel16 *px) {
  PF_Err err = PF_Err_NONE;
...
PF_Err BrightnessSub(refconType refcon, A_long xL, A_long yL, PF_Pixel16 *px) {
  PF_Err err = PF_Err_NONE;

...
// User interface ID
// Becomes the ID for the params parameter of ParamsSetup and Render functions
enum {
...
/*
    0bit: 1 for target pixel
    1bit: 1 for decision pixel
    2bit and after are table index.
*/
#define CT_NONE 0
#define CT_TARGET 1
#define CT_SEARCH 2
...
PF_Err AlphaThreshold8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                       PF_Pixel8* outP);
PF_Err AlphaThreshold16(refconType refcon, A_long xL, A_long yL,
                        PF_Pixel16* inP, PF_Pixel16* outP);
PF_Err AlphaThreshold32(refconType refcon, A_long xL, A_long yL,
                        PF_PixelFloat* inP, PF_PixelFloat* outP);

PF_Err AlphaFix8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                 PF_Pixel8* outP);
PF_Err AlphaFix16(refconType refcon, A_long xL, A_long yL, PF_Pixel16* inP,
                  PF_Pixel16* outP);
PF_Err AlphaFix32(refconType refcon, A_long xL, A_long yL, PF_PixelFloat* inP,
                  PF_PixelFloat* outP);

PF_Err hslMatch8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                 PF_Pixel8* outP);
PF_Err hslMatch16(refconType refcon, A_long xL, A_long yL, PF_Pixel16* inP,
                  PF_Pixel16* outP);
PF_Err hslMatch32(refconType refcon, A_long xL, A_long yL, PF_PixelFloat* inP,
                  PF_PixelFloat* outP);

PF_Err line_search8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                    PF_Pixel8* outP);
PF_Err line_search16(refconType refcon, A_long xL, A_long yL, PF_Pixel16* inP,
                     PF_Pixel16* outP);
PF_Err line_search32(refconType refcon, A_long xL, A_long yL,
                     PF_PixelFloat* inP, PF_PixelFloat* outP);

PF_Err use_search8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                   PF_Pixel8* outP);
PF_Err use_search16(refconType refcon, A_long xL, A_long yL, PF_Pixel16* inP,
                    PF_Pixel16* outP);
PF_Err use_search32(refconType refcon, A_long xL, A_long yL, PF_PixelFloat* inP,
                    PF_PixelFloat* outP);

PF_Err use_searchSub8(refconType refcon, A_long xL, A_long yL, PF_Pixel8* inP,
                      PF_Pixel8* outP);
PF_Err use_searchSub16(refconType refcon, A_long xL, A_long yL, PF_Pixel16* inP,
                       PF_Pixel16* outP);
PF_Err use_searchSub32(refconType refcon, A_long xL, A_long yL,
                       PF_PixelFloat* inP, PF_PixelFloat* outP);

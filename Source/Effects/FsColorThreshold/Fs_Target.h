...
#define FS_DESCRIPTION "Converts colors to single colors."
...
// Enabling this will not include FsGraphics related files
...
// #define FS_OUT_FLAGS	33556036	//Enabling this will draw every frame.

...
// The text used for the plugin description
#define NFS_DESCRIPTION "Plugin skeleton"

// The menu name where the plugin is displayed
...
// #define NFS_OUT_FLAGS	33556036	// If this is enabled, it will
// be drawn every frame. Also use this when switching NON_PARAM_VARY during
// operation.

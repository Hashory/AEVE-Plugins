...
static PF_Err Mask8(refconType refcon, A_long xL, A_long yL, PF_Pixel8 *inP,
  ...
  if (col.alpha == 0) {
    ...
    switch (niP->mode) {
      case M_MODE::RED:
      case M_MODE::CYAN:
        v = RoundByteFpLong((A_long)col.red -
                            MAX((A_long)col.green, (A_long)col.blue));
        break;
      case M_MODE::GREEN:
      case M_MODE::MAGENTA:
        v = RoundByteFpLong((A_long)col.green -
                            MAX((A_long)col.blue, (A_long)col.red));
        break;
      case M_MODE::BLUE:
      case M_MODE::YELLOW:
        v = RoundByteFpLong((A_long)col.blue -
                            MAX((A_long)col.red, (A_long)col.green));
        break;
      case M_MODE::MAX:
...
static PF_Err Mask16(refconType refcon, A_long xL, A_long yL, PF_Pixel16 *inP,
  ...
  if (col.alpha == 0) {
    ...
    switch (niP->mode) {
      case M_MODE::RED:
      case M_MODE::CYAN:
        v = RoundShortFpLong((A_long)col.red -
                             MAX((A_long)col.green, (A_long)col.blue));
        break;
      case M_MODE::GREEN:
      case M_MODE::MAGENTA:
        v = RoundShortFpLong((A_long)col.green -
                             MAX((A_long)col.red, (A_long)col.blue));
        break;
      case M_MODE::BLUE:
      case M_MODE::YELLOW:
        v = RoundShortFpLong((A_long)col.blue -
                             MAX((A_long)col.red, (A_long)col.green));
        break;
      case M_MODE::MAX:
        v = MAX((A_long)col.blue, MAX((A_long)col.red, (A_long)col.green));

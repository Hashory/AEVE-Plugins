...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  // チェックボックス
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_DELTA_CB, STR_CB, TRUE, 0, ID_DELTA_CB);
  //----------------------------------------------------------------
  // 固定小数のスライダーバー
  AEFX_CLR_STRUCT(def);
  PF_ADD_FIXED(STR_DELTA_OPACITY,  // パラメータの名前
               ...
               100,                // デフォルトの値
               1,                  // 数値表示に関するフラグ
               0, 0, ID_DELTA_OPACITY);
  //----------------------------------------------------------------
  // チェックボックス
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_ALPHA_CB, STR_CB, FALSE, 0, ID_ALPHA_CB);
  //----------------------------------------------------------------
  // 固定小数のスライダーバー
  AEFX_CLR_STRUCT(def);
  PF_ADD_FIXED(STR_ALPHA_OPACITY,  // パラメータの名前
               ...
               100,                // デフォルトの値
               1,                  // 数値表示に関するフラグ
               0, 0, ID_ALPHA_OPACITY);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_LINE_COLOR, 0x0, 0x0, 0x0, ID_LINE_COLOR);
  /*
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  ...
  PF_ADD_FIXED(	STR_COLOR_OPACITY,	//パラメータの名前
                                  0,
  //数値入力する場合の最小値 300, //数値入力する場合の最大値 0,

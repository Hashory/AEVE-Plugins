...
inline PF_Boolean ComparePix8(PF_Pixel8 *s, PF_Pixel8 *d, A_long lv) {
  return ((ABS(s->red - d->red) <= lv) && (ABS(s->green - d->green) <= lv) &&
          (ABS(s->blue - d->blue) <= lv));
}
//-----------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------
inline PF_Boolean ComparePix32(PF_PixelFloat *s, PF_PixelFloat *d,
                               PF_FpShort lv) {
  return ((ABS(s->red - d->red) <= lv) && (ABS(s->green - d->green) <= lv) &&
          (ABS(s->blue - d->blue) <= lv));
}

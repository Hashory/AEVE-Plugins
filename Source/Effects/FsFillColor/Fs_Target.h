...
#define FS_DESCRIPTION "Fill opaque areas"
...
// #define FS_OUT_FLAGS33556036	//Enable this to draw every frame. Also use
// this when switching NON_PARAM_VARY during operation

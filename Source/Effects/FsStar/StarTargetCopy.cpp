...
static PF_Err TargetCopy8(refconType refcon, A_long xL, A_long yL,
                          PF_Pixel8* inP, PF_Pixel8* outP) {
  PF_Err err = PF_Err_NONE;

  A_u_char mp = MAX(inP->red, MAX(inP->green, inP->blue));

  outP->blue = outP->green = outP->red = outP->alpha =
      RoundByteLong(mp * inP->alpha / PF_MAX_CHAN8);
  return err;
}
static PF_Err TargetCopy16(refconType refcon, A_long xL, A_long yL,
  ...
  outP->blue = outP->green = outP->red = outP->alpha =
      RoundShort(mp * inP->alpha / PF_MAX_CHAN16);
  return err;
}
static PF_Err TargetCopy32(refconType refcon, A_long xL, A_long yL,
  ...
  outP->blue = outP->green = outP->red = outP->alpha =
      RoundFpShortDouble(mp * inP->alpha);
  return err;
}
...
static PF_Err ScreenCopy8(refconType refcon, A_long xL, A_long yL,
                          PF_Pixel8* inP, PF_Pixel8* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err ScreenCopy16(refconType refcon, A_long xL, A_long yL,
                           PF_Pixel16* inP, PF_Pixel16* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err ScreenCopy32(refconType refcon, A_long xL, A_long yL,
                           PF_PixelFloat* inP, PF_PixelFloat* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err FillColor8(refconType refcon, A_long xL, A_long yL,
                         PF_Pixel8* inP, PF_Pixel8* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err FillColor16(refconType refcon, A_long xL, A_long yL,
                          PF_Pixel16* inP, PF_Pixel16* outP) {
  PF_Err err = PF_Err_NONE;
  ColorFillInfo* infoP = reinterpret_cast<ColorFillInfo*>(refcon);
...
static PF_Err FillColor32(refconType refcon, A_long xL, A_long yL,
                          PF_PixelFloat* inP, PF_PixelFloat* outP) {
  PF_Err err = PF_Err_NONE;
  ColorFillInfo* infoP = reinterpret_cast<ColorFillInfo*>(refcon);
...
static PF_Err AlphaMake8(refconType refcon, A_long xL, A_long yL,
                         PF_Pixel8* inP, PF_Pixel8* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err AlphaMake16(refconType refcon, A_long xL, A_long yL,
                          PF_Pixel16* inP, PF_Pixel16* outP) {
  PF_Err err = PF_Err_NONE;
...
static PF_Err AlphaMake32(refconType refcon, A_long xL, A_long yL,
                          PF_PixelFloat* inP, PF_PixelFloat* outP) {
  PF_Err err = PF_Err_NONE;

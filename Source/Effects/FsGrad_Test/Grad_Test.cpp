...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  // Specify the color
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_START_COL, 0x00, 0x00, 0x00, ID_START_COL);
  // Specify the color
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_LAST_COL, 0xFF, 0xFF, 0xFF, ID_LAST_COL);
...
/*
        This function is called for hosts that do not support SmartFX (pre-After
   Effects 7) to perform rendering. Including this function ensures

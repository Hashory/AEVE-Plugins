...
#define FS_DESCRIPTION "Colorizes based on brightness."
...
// Enable this to prevent FsGraphics-related files from being included
...
// during operation. #define FS_OUT_FLAGS	33556036 // 8bit only #define
// FS_OUT_FLAGS	1600

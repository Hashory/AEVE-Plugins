...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_COLOR1, 0x0F, 0x0F, 0x0F, ID_COLOR1);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_COLOR2_ON, STR_ON, TRUE, 0, ID_COLOR2_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  ...
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_COLOR3_ON, STR_ON, TRUE, 0, ID_COLOR3_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_COLOR3, 0x05, 0x05, 0x05, ID_COLOR3);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  ...
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_COLOR4, 0x00, 0x00, 0x00, ID_COLOR4);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_COLOR5_ON, STR_ON, FALSE, 0, ID_COLOR5_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_COLOR5, 0x00, 0x00, 0x00, ID_COLOR5);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_COLOR6_ON, STR_ON, FALSE, 0, ID_COLOR6_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_COLOR6, 0x00, 0x00, 0x00, ID_COLOR6);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  ...
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_IG_COLOR, 0x10, 0x10, 0x10, ID_IG_COLOR);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  ...
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_NEG_COLOR1_ON, STR_ON, FALSE, 0, ID_NEG_COLOR1_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_NEG_COLOR1, 0xFE, 0xFE, 0xFE, ID_NEG_COLOR1);
  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_NEG_COLOR2_ON, STR_ON, FALSE, 0, ID_NEG_COLOR2_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_NEG_COLOR2, 0xFD, 0xFD, 0xFD, ID_NEG_COLOR2);

  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_NEG_COLOR3_ON, STR_ON, FALSE, 0, ID_NEG_COLOR3_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_NEG_COLOR3, 0xFC, 0xFC, 0xFC, ID_NEG_COLOR3);

  //----------------------------------------------------------------
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX(STR_NEG_COLOR4_ON, STR_ON, FALSE, 0, ID_NEG_COLOR4_ON);
  //----------------------------------------------------------------
  // 色の指定
  AEFX_CLR_STRUCT(def);
  PF_ADD_COLOR(STR_NEG_COLOR4, 0xFC, 0xFC, 0xFC, ID_NEG_COLOR4);
  //----------------------------------------------------------------
...
static PF_Boolean FindNegColor(ParamInfo *infoP, PF_Pixel p) {
  ...
  if (infoP->ngColorMax > 0) {
    for (int i = 0; i < infoP->ngColorMax; i++) {
      if ((p.blue == infoP->ngColor[i].blue) &&

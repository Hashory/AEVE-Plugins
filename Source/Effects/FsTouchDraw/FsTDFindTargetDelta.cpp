...
inline A_long SubtrucPixel16(PF_Pixel16 s, PF_Pixel16 d) {
  ...
  v += F_ABS(s.green * s.alpha / PF_MAX_CHAN16 -
             d.green * d.alpha / PF_MAX_CHAN16);
  v += F_ABS(s.blue * s.alpha / PF_MAX_CHAN16 -
             d.blue * d.alpha / PF_MAX_CHAN16);
...
static PF_Err DeltaSub8(refconType refcon, A_long xL, A_long yL, PF_Pixel8 *inP,
                        PF_Pixel8 *outP) {
...
static PF_Err DeltaSub16(refconType refcon, A_long xL, A_long yL,
...
static PF_Err DeltaSub32(refconType refcon, A_long xL, A_long yL,

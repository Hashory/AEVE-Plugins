...
static PF_Err ParamsSetup(PF_InData *in_data, PF_OutData *out_data,
  ...
  PF_ADD_CHECKBOX("毎フレームでノイズ変化", "ON", TRUE, 0, ID_ANIMATED_CB);
  ...
  // チェックボックス
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX("カラーノイズ", "ON", (PF_ParamValue)FALSE, 0, ID_COLOR_CB);
  ...
  // チェックボックス
  AEFX_CLR_STRUCT(def);
  PF_ADD_CHECKBOX("カラーブロック", "ON", FALSE, 0, ID_BLOCK_COLOR_CB);
